        ...
        <div className="w-full max-w-md">
          ...
          {step === 1 && (
            <div className="gs-fade-in">
              <h1 className="text-[24px] font-semibold text-gray-900 tracking-tight mb-1">Company details</h1>
              <p className="text-[14px] text-gray-500 mb-8">Tell us about your platform.</p>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  ...
                  <input type="text" value={companyName}
                    ...
                    placeholder="Swiggy, Zomato, Dunzo..."
                    autoFocus
              ...
              <button onClick={() => {
                ...
                if (!contactName.trim()) { setErrors({ contact: "Enter your name" }); return; }
                setStep(2);
          ...
          {step === 2 && (
            <div className="gs-fade-in">
              <h1 className="text-[24px] font-semibold text-gray-900 tracking-tight mb-1">Coverage & volume</h1>
              <p className="text-[14px] text-gray-500 mb-8">Where do you need riders and how many?</p>
                    ...
                    return (
                      <button key={z} onClick={() => toggleZone(z)}
                        className={`py-2.5 px-3 rounded-lg border text-[13px] text-left cursor-pointer transition-all flex items-center justify-between ${
                          selected ? "border-[#059669] bg-[#F0FDF4] text-[#059669]" : "border-gray-200 text-gray-600 hover:border-gray-300"
                        }`}>
                        {z}
          ...
          {step === 3 && (
            <div className="gs-fade-in">
              <h1 className="text-[24px] font-semibold text-gray-900 tracking-tight mb-1">Review & confirm</h1>
              <p className="text-[14px] text-gray-500 mb-8">Everything look right?</p>
              ...
              <div className={`rounded-xl border ${surface} overflow-hidden mb-6`}>
                {[
                  ...
                  <div key={row.label} className={`flex items-start justify-between px-4 py-3 ${i < arr.length - 1 ? "border-b border-gray-100" : ""}`}>
                    ...
                    <span className="text-[13px] font-medium text-gray-900 text-right ml-4">{row.value}</span>
                  </div>
                ))}
              </div>
